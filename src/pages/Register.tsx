...
import { Lock, Mail, BookOpen, User } from 'lucide-react';
...
const Register = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!formData.regdNo || !formData.branch || !formData.stream || !formData.year) {
    ...
    try {
      ...
      // Register the user and redirect to dashboard
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 flex items-center justify-center p-4">
      <div className="bg-white p-8 rounded-2xl shadow-xl w-full max-w-2xl">
        <div className="text-center mb-8">
          <h1 className="text-3xl font-bold text-gray-800 mb-2">Create Student Account</h1>
